{
  ...
  "github-code-owners.format.alignment-offset": 4,
  "github-code-owners.format.enabled": true,
  ...
  "openInGitHub.defaultPullRequestBranch": "main",
  "openInGitHub.gitHubDomain": "github.com",
  "openInGitHub.providerProtocol": "https",
  "openInGitHub.providerType": "github",
  "openInGitHub.requireSelectionForLines": true,
  "openInGitHub.useCommitSHAInURL": true,
  ...
  "docker.languageserver.diagnostics.instructionHealthcheckMultiple": "error",
  ...
  "hadolint.outputLevel": "error",
  "hadolint.maxNumberOfProblems": 100,
  // goplicate-end:containers
  //
  // goplicate-start:frontend
  "[css]": {
  ...
  "codemetrics.basics.ComplexityLevelExtremeDescription": "Do not commit this code.",
  "codemetrics.basics.ComplexityLevelHigh": 20,
  "codemetrics.basics.ComplexityLevelHighDescription": "It's time to refactor into smaller functions.",
  "codemetrics.basics.ComplexityLevelLowDescription": "Not complex.",
  "codemetrics.basics.ComplexityLevelNormal": 10,
  "codemetrics.basics.ComplexityLevelNormalDescription": "Average complexity.",
  ...
  "emeraldwalk.runonsave": {
    "commands": [
      {
        "match": "\\.go$",
        "cmd": "golines --base-formatter=gofumpt --write-output --max-len=120 ${file}"
      }
    ]
  },
  "go.addTags": {
  ...
  //
  // goplicate-start:graphql
  // goplicate-end:graphql
  //
  // goplicate-start:iac
  "[terraform]": {
  ...
  "cfnLint.completion": true,
  "cfnLint.format.bracketSpacing": false,
  "cfnLint.format.enable": true,
  "cfnLint.format.printWidth": 120,
  "cfnLint.format.proseWrap": "always",
  "cfnLint.format.singleQuote": true,
  "cfnLint.hover": true,
  ...
  // goplicate-end:markdown
  //
  // goplicate-start:protobuf
  // goplicate-end:protobuf
  //
  ...
  "yapf.showDebugLog": false,
  // goplicate-end:python
  //
  // goplicate-start:security
  "1password.editor.suggestStorage": true,
  "1password.items.cacheValues": true,
  "1password.items.passwordRecipe": "letters,digits,symbols,72",
  "1password.items.useSecretReferences": true,
  "redHatDependencyAnalytics.vulnerabilityAlertSeverity": "Warning",
  "redHatDependencyAnalyticsServer.trace.server": "off",
  ...
  "shellformat.flag": "--simplify -ln=bash --indent=4 --case-indent --space-redirects --binary-next-line --apply-ignore",
